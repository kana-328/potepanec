ActiveRecord::Schema.define(version: 2020_01_10_032920) do
  ...
  create_table "spree_adjustment_reasons", id: :integer,
  ...
  create_table "spree_adjustments", id: :integer,
                                    options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "spree_assets",
               id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "spree_line_item_actions",
               id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "spree_order_mutexes",
               id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "order_id", null: false
    t.datetime "created_at", precision: 6
  ...
  create_table "spree_orders_promotions",
               id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "order_id"
  ...
  create_table "spree_products_taxons",
               id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "product_id"
    t.integer "taxon_id"
    t.integer "position"
  ...
  create_table "spree_promotion_actions",
               id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "promotion_id"
    t.integer "position"
    t.string "type"
  ...
  create_table "spree_promotion_codes",
               id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "promotion_id", null: false
  ...
  create_table "spree_promotion_rules",
               id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "promotion_id"
  ...
  create_table "spree_prototype_taxons",
               id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "taxon_id"
    t.integer "prototype_id"
    t.datetime "created_at", precision: 6
  ...
  create_table "spree_return_items",
               id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "spree_return_reasons",
               id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "name"
    t.boolean "active", default: true
    t.boolean "mutable", default: true
  ...
  create_table "spree_roles_users",
               id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "role_id"
    t.integer "user_id"
    t.datetime "created_at", precision: 6
  ...
  create_table "spree_shipping_rate_taxes",
               id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "spree_unit_cancels",
               id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "spree_user_addresses",
               id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "spree_variant_property_rule_conditions",
    ...
    t.index %w[variant_property_rule_id
               option_value_id], name: "index_spree_variant_prop_rule_conditions_on_rule_and_optval"
  end
  ...
  create_table "spree_wallet_payment_sources",
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index %w[user_id payment_source_id
               payment_source_type],
